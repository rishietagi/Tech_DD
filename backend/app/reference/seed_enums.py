...
_ENUM_CLASSES: dict[str, type[Enum]] = {
    ...
    "investorType": enum_module.InvestorType,
    "investorTechCapability": enum_module.InvestorTechCapability,
    "sector": enum_module.Sector,
    "businessModel": enum_module.BusinessModel,
    "revenueModel": enum_module.RevenueModel,
    ...
    "codeAccess": enum_module.CodeAccess,
